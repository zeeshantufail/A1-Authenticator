...
-(void)setUpOtpRefrences{
    self.delegate = [OTPAuthAppDelegate sharedDelegate];
    [OTPAuthAppDelegate sharedDelegate].navigationController = self.navigationController;
    [OTPAuthAppDelegate sharedDelegate].rootViewController = self;
}


- (void)viewDidLoad {
    
    [self setUpOtpRefrences];
...
- (IBAction)addAuthUrl:(id)sender {
    [[OTPAuthAppDelegate sharedDelegate] addAuthURL:sender];
}
@end
