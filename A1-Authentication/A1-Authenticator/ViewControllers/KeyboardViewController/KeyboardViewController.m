...
//    if (passCodeViewController.passCode.length > 0) {
//        [self reverseAnimateDotNo:(int)passCodeViewController.passCode.length];
//        [passCodeViewController.passCode replaceCharactersInRange:NSMakeRange(passCodeViewController.passCode.length-1, 1) withString:@""];
//    }
//    
//}
//
...
//    
//    if ([passCodeViewController.passCode length] == 4) {
//        return;
//    }
//    if (passCodeViewController.passCodeEntryFailed) {
//        passCodeViewController.passCodeEntryFailed = NO;
//        passCodeViewController.errorLabel.hidden = YES;
//        passCodeViewController.warningLabel.hidden = YES;
//    }
//    pinLength = 4;
//    if (passCodeViewController.passCode.length < pinLength) {
//        [passCodeViewController.passCode appendString:[NSString stringWithFormat:@"%ld", (long)b.tag]];
//    }
//    if(passCodeViewController.passCode.length > 0)
//        [self animateDotNo:(int)passCodeViewController.passCode.length];
//    
//    if ([passCodeViewController.passCode length] == pinLength) {
...
//
//- (void)clearAlldata {
//    passCodeViewController.passCode = [[NSMutableString alloc] initWithCapacity:4];
//    //add by zeeshan
//    [self performSelector:@selector(clearImageDots) withObject:nil afterDelay:0.5];
//}
//-(void)clearImageDots{
//    [self performSelector:@selector(imageSet) withObject:nil afterDelay:2];
//}
//
//-(void)imageSet{
//    
